...
ifeq ($(USES_DEVICE_XIAOMI_MI710_MAINLINE),true)
...
INSTALLED_MI710_ESPIMAGE_TARGET_INCLUDE_FILES := \
    $(PRODUCT_OUT)/boot.img \
    $(PRODUCT_OUT)/recovery.img \
    $(PRODUCT_OUT)/vendor_boot.img

INSTALLED_MI710_ESPIMAGE_TARGET_DEPS := \
...
define make-espimage-target
	$(hide) mkdir -p $(dir $(INSTALLED_MI710_ESPIMAGE_TARGET))
	$(call pretty,"Target EFI System Partition image: $(INSTALLED_MI710_ESPIMAGE_TARGET)")
	...
	cp $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/arch/arm64/boot/dts/qcom/sdm710-xiaomi-*.dtb $(ESP_OUT_DIR)/dtb/qcom/

	$(call create-fat32image,$(INSTALLED_MI710_ESPIMAGE_TARGET),$(ESP_OUT_DIR)/* $(INSTALLED_MI710_ESPIMAGE_TARGET_INCLUDE_FILES),EFI)
endef

$(INSTALLED_MI710_ESPIMAGE_TARGET): $(INSTALLED_MI710_ESPIMAGE_TARGET_DEPS)
	$(call make-espimage-target)

.PHONY: espimage
espimage: $(INSTALLED_MI710_ESPIMAGE_TARGET)

.PHONY: espimage-nodeps
espimage-nodeps:
	@echo "make $(INSTALLED_MI710_ESPIMAGE_TARGET): ignoring dependencies"
	$(call make-espimage-target)
